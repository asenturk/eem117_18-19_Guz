...
int main(int argc, char** argv) {
	...
	// str.find() fonksiyonu kullanıldığında ilk bulunan stringin konumunu verir.
	// Eğer bulamazsa  string::npos değerini döndürür.
	// Dolayısıyla yukarıdaki ifade her ne kadar istenildiği şekilde çalışıyorsa da
	...
	// }
	// bu durum aşağıda farklı değişkenler kullanılarak örneklendirilmiştir.
